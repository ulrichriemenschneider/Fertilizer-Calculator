...
Ähnliche Angaben sind auch bei den anderen Düngern vorhanden (in diesem Fall Eisen und Nitrat). Das Problem ist nun, dass z.B. Kalium (K) in allen 3 Düngern vorhanden ist und das bei der Düngeempfehlung nicht berücksichtigt wird oder ignoriert wird. Dem Hersteller ist das bewusst und löst das Problem indem er folgende Information mitgibt:
...
Wenn man nun aber 4 Aquarien mit einem Gesamtvolumen von 450l hat möchte man nicht jede Woche die Zeit investieren an 4 Aquarien einen Wasserwechsel durchzuführen und ggf. auch noch jede Woche 200l Wasser aufbereiten… und nicht zuletzt handelt sich sich dabei um eine massive Trinkwasserverschwendung.

## Die Lösung - Grundlegende Funktion:

Die Web-app soll den Nutzer bei der Berechnung von Mengen unterstützen und Ihm Hochrechnungen zur Verfügung stellen.
